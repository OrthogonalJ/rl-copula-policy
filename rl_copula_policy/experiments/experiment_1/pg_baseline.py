...
if __name__ == '__main__':
    ...
    base_export_dir = '{}/pg_baseline_{}'.format(args.export_dir, current_timestamp())
    ...
    for params in param_grid:
        ...
        exp_name = 'pg_baseline_v3_{}_{}'.format(model_name, env_name)
        export_dir = '{}/{}'.format(base_export_dir, exp_name)

        run_experiment_repeatedly(exp_name, 'PG', num_iter=num_iter, 
